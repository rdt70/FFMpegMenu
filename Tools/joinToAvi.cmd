...
:encodeVideo
	...
	"%~dp0\ffmpeg" -i "%_file%"  -vcodec  mpeg4 -vtag xvid -b:v %bitrate% -pass 1 -acodec copy -f avi "%_file%_temp.avi"
	"%~dp0\ffmpeg" -i "%_file%_temp.avi" -vcodec mpeg4 -vtag xvid -b:v %bitrate% -pass 2 -acodec libmp3lame -b:a 128k "%_file%.avi"
	del "%_file%_temp.avi"
